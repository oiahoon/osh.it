...
echo "• Official Website: ${YELLOW}https://oiahoon.github.io/osh.it/${NC}"
echo "• Documentation: ${YELLOW}https://github.com/oiahoon/osh.it/wiki${NC}"
echo "• Support: ${YELLOW}https://github.com/oiahoon/osh.it/issues${NC}"
echo ""
